...
public class MySyncUtils {
    ...
    Response sendPostRequest(String[] keys, String[] values) throws IOException {
    ...
    Response sendPostRequest(String JSONString) throws IOException {
        HttpRequests httpRequests = new HttpRequests(mySyncAccessTokenKey,mySyncAccessTokenValue);
        httpRequests.setServerAddress(mySyncServerAddress);
        return httpRequests.sendRequest(
                httpRequests.genPostRequest(
    ...
    Response sendGetRequest() throws IOException {
        HttpRequests httpRequests = new HttpRequests(mySyncAccessTokenKey,mySyncAccessTokenValue);
        httpRequests.setServerAddress(mySyncServerAddress);
        return httpRequests.sendRequest(
    ...
    Response sendDeleteRequest() throws IOException {
        HttpRequests httpRequests = new HttpRequests(mySyncAccessTokenKey,mySyncAccessTokenValue);
        httpRequests.setServerAddress(mySyncServerAddress);
        return httpRequests.sendRequest(
